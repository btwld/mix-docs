...
<Info>
  See the [fortalIconButtonStyler source code](https://github.com/btwld/remix/blob/main/lib/src/components/icon_button/fortal_icon_button_styles.dart) for all available options.
</Info>
...
|------|------|--------------------------|
| `style` | `RemixIconButtonStyler` | Optional. The style configuration for the icon button. Customize colors, sizing, and state-based styling. |
