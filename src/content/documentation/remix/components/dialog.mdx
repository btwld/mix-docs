      ...
      onPressed: () {
        showRemixDialog(
          ...
          builder: (context) => Center(
            child: FortalDialog(
              title: 'Revoke access',
              description: 'This application will no longer be accessible.',
              actions: [
                FortalButton.ghost(
                  label: 'Cancel',
  ...
  Widget build(BuildContext context) {
    return FortalDialog(
      ...
      actions: [
        ...
        FortalButton(label: 'Save', onPressed: () => Navigator.pop(context)),
      ],
    );
  }
}
...
Future<T?> showRemixDialog<T>({
  ...
  Offset? anchorPoint,
  Duration transitionDuration = const .new(milliseconds: 400),
