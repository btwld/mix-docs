...
|------|------|--------------------------|
| `style` | `RemixRadioStyle` | Optional. The style configuration for the radio button. Customize colors, borders, and state-based styling. |
...
| `enableFeedback` | `bool` | Optional. Whether to provide feedback when the radio button is pressed. |
