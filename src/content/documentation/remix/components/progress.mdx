...
<Info>
  See the [fortalProgressStyler source code](https://github.com/btwld/remix/blob/main/lib/src/components/progress/fortal_progress_styles.dart) for all available options.
</Info>
...
|------|------|--------------------------|
| `style` | `RemixProgressStyler` | Optional. The style configuration for the progress indicator. Customize colors, sizing, and track appearance. |
