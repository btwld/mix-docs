      ...
      child: Column(
        children: [
          RemixTabBar(
            ...
            child: Row(
              children: [
                RemixTab(tabId: 'tab1', label: 'Tab 1', style: fortalTabStyler()),
                RemixTab(tabId: 'tab2', label: 'Tab 2', style: fortalTabStyler()),
              ],
            ),
          ),
          RemixTabView(tabId: 'tab1', style: fortalTabViewStyler(), child: Text('Content 1')),
          RemixTabView(tabId: 'tab2', style: fortalTabViewStyler(), child: Text('Content 2')),
        ],
      ),
    );
  }
