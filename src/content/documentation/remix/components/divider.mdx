...
You can use `RemixDividerStyler` to create styles with a fluent API. Example:
...
Remix ships a generated `FortalDivider` component with size presets:

```dart
FortalDivider(size: .size1);
FortalDivider(size: .size2);
```

See the [fortalDividerStyler source](https://github.com/btwld/remix/blob/main/lib/src/components/divider/fortal_divider_styles.dart) for the full set of options.

## Constructor

| Prop | Type | Required / Default Value |
|------|------|--------------------------|
| `style` | `RemixDividerStyler` | Optional, defaults to `const RemixDividerStyler.create()` |
