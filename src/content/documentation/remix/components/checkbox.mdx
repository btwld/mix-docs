...
class _CheckboxExampleState extends State<CheckboxExample> {
  ...
  RemixCheckboxStyler get style {
    return RemixCheckboxStyler()
        ...
        .onSelected(RemixCheckboxStyler().color(Colors.grey.shade900))
...
<Info>
  See the [fortalCheckboxStyler source code](https://github.com/btwld/remix/blob/main/lib/src/components/checkbox/fortal_checkbox_styles.dart) for all available options.
</Info>
...
| `style` | `RemixCheckboxStyler` | Optional. The style configuration for the checkbox. |
...
| `onIndeterminate(RemixCheckboxStyler value)` | Style applied when the checkbox is in the indeterminate state. |
