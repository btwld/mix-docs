              ...
              .decoration(
                BoxDecorationMix.color(Colors.white)
                    ...
                    .boxShadow([
                      ...
                      ).blurRadius(3).offset(x: 0, y: 3),
                    ]),
              )
              .constraints(.minHeight(40))
              .label(.color(Colors.blueGrey.shade700).fontWeight(.w400)),
        )
        .overlay(
          .padding(.all(12)).decoration(
            BoxDecorationMix.color(Colors.white)
                .borderRadius(.circular(12))
                .border(.all(.color(Colors.blueGrey.shade100)))
                .boxShadow([
...
<Info>
  See the [fortalMenuStyler source code](https://github.com/btwld/remix/blob/main/packages/remix/lib/src/components/menu/fortal_menu_styles.dart) for all available options.
</Info>
