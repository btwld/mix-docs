...
class _TextfieldExampleState extends State<TextfieldExample> {
  ...
  RemixTextFieldStyler get style {
    return RemixTextFieldStyler()
        ...
        .paddingX(12)
        .spacing(8)
        .label(.color(Colors.blueGrey.shade900).fontWeight(.w500))
        .helperText(.fontWeight(.w300).color(Colors.blueGrey.shade600))
        .hintColor(Colors.blueGrey.shade500)
        .shadow(.blurRadius(1).color(Colors.black12).offset(x: 0, y: 1))
