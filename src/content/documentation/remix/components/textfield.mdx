...
<Info>
  See the [fortalTextFieldStyler source code](https://github.com/btwld/remix/blob/main/lib/src/components/textfield/fortal_textfield_styles.dart) for all available options.
</Info>
...
| `style` | `RemixTextFieldStyler` | Optional. The style configuration for the text field. |
