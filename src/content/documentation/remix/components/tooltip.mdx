...
Remix includes a generated Fortal tooltip component:
...
<Info>
  See the [fortalTooltipStyler source code](https://github.com/btwld/remix/blob/main/lib/src/components/tooltip/fortal_tooltip_styles.dart) for all available options.
</Info>
...
| `style` | `RemixTooltipStyler` | Optional. The style configuration for the tooltip. |
...
| `dismissDuration(Duration value)` | Sets the hover-exit grace duration before the tooltip closes |
