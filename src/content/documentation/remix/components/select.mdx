...
<Info>
  See the [fortalSelectStyler source code](https://github.com/btwld/remix/blob/main/lib/src/components/select/fortal_select_styles.dart) for all available options.
</Info>
...
| `positioning` | `OverlayPositionConfig` | Optional. Overlay positioning configuration for the dropdown. |
...
| `style` | `RemixSelectStyler` | Optional. The style configuration for the select. |
