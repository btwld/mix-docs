  ...
  RemixSelectStyler get style {
    return RemixSelectStyler()
        .trigger(
          ...
          .border(.color(Colors.grey.shade600))
          .paddingY(10)
          .paddingX(12)
...
<Info>
  ...
  See the [fortalSelectStyler source code](https://github.com/btwld/remix/blob/main/packages/remix/lib/src/components/select/fortal_select_styles.dart) for all available options.
</Info>
