...
<Info>
  See the [fortalAvatarStyler source code](https://github.com/btwld/remix/blob/main/lib/src/components/avatar/fortal_avatar_styles.dart) for all available options.
</Info>
...
|------|------|--------------------------|
| `style` | `RemixAvatarStyler` | Optional. The style configuration for the avatar. Customize colors, sizing, shape, and state-based styling. |
