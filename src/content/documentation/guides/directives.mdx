...
```dart
// Chain: multiply by 2, then add 5, then clamp between 0-30 (use .create() for number directives)
...
// Proportional typography scaling (use .create() when using Prop with directives)
