...
<Callout type="info">
  **Prerequisites:** You should be familiar with [Design Tokens](/documentation/guides/design-token) before reading this guide.
</Callout>
...
For standard styling needs, prefer the [built-in token types](/documentation/guides/design-token#built-in-token-types).

## See Also

- [Design Tokens](/documentation/guides/design-token) — declaring, providing, and referencing built-in tokens
- [Directives](/documentation/guides/directives) — chaining `Prop.token()` with `.multiply()`, `.add()`, and other transforms
