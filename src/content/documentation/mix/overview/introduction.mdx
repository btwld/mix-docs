...
Use this pattern when defining styles with direct values, chaining multiple properties, or building most common styling use cases. Learn more about [styling](/documentation/mix/guides/styling).

For advanced composition with design tokens and directives, Mix also offers a [Prop-based API](/documentation/mix/guides/styling) using the `.create()` constructor:
...
Learn more about [Dynamic Styling](/documentation/mix/guides/dynamic-styling).

### Animation Support

Mix supports implicit animations, phase animations (multi-step sequences), and keyframe animations. Learn more in the [Animations Guide](/documentation/mix/guides/animations).

### Widget Modifiers

Some visual effects — opacity, clipping, visibility — aren't style properties. Modifiers let you declare widget wrappers inside your style so they stay composable and animatable. Learn more in the [Widget Modifiers Guide](/documentation/mix/guides/widget-modifiers).

### Directives

Directives transform values (text casing, number scaling, color adjustments) at resolve time, keeping transformations inside the style so they survive merging. Learn more in the [Directives Guide](/documentation/mix/guides/directives).
...
Learn more about [Design Tokens and Theming](/documentation/mix/guides/design-token).

## Next Steps

Ready to start building? Head to the [Getting Started](/documentation/mix/overview/getting-started) guide to set up Mix and create your first styled widget. For a full reference of available widgets, see the [Widgets](/documentation/mix/widgets/stylewidgets) section.
