...
- [Getting Started](/documentation/mix/overview/getting-started) — install Mix and build your first widget
- [Dynamic Styling](/documentation/mix/guides/dynamic-styling) — deep dive into variants like `onHovered` and `onPressed`
