...
final label = TextStyler().color(Colors.white).fontSize(18).fontWeight(.w600);
...
- [FlexBox](/documentation/mix/widgets/flexbox) — flex layout with box styling
- [Styling with Mix](/documentation/mix/guides/styling) — fluent Styler API patterns
- [Dynamic Styling](/documentation/mix/guides/dynamic-styling) — variants for hover, press, dark mode
