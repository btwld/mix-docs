...
StyledImage(image: NetworkImage('https://picsum.photos/160'), style: style)
```
...
- [Box](/documentation/mix/widgets/box) — container styling with `BoxStyler`
- [Styling with Mix](/documentation/mix/guides/styling) — fluent Styler API basics
