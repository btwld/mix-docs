...
<Callout type="info">
  `PressableBox` = `Pressable` + `Box`. If you need interaction tracking around a another widget instead of a `Box`, use just `Pressable` directly. See the [Pressable reference](/documentation/mix/widgets/pressable).
</Callout>
