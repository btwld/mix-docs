...
<Callout type="info">
  **Prerequisites:** This guide assumes familiarity with Mix's [Styling](/documentation/mix/guides/styling) patterns. If you're new to Mix, start there first.
</Callout>
...
- [Animations](/documentation/mix/guides/animations) — animate modifier transitions with implicit, phase, or keyframe animations
- [Directives](/documentation/mix/guides/directives) — transform values (text, numbers, colors) at resolve time
