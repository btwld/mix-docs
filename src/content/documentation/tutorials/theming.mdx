...
<FlutterPreview previewId="tutorials/theming.0" title="Theme switching with tokens" description="Toggle theme to see tokens update colors and spacing." height={280} />
