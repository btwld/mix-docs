---
title: Codecs
description: Convert between JSON-safe boundary values and Dart runtime types like DateTime and Uri with codecs
---
...
Errors surface as typed [`SchemaError`](/documentation/ack/essentials/error-handling) values:
...
- **[Schema Types](/documentation/ack/essentials/schemas)**: Schema types and the `transform` helper
- **[Validation Rules](/documentation/ack/essentials/validation)**: Built-in constraints
- **[Error Handling](/documentation/ack/essentials/error-handling)**: `SchemaError` and `SchemaResult`
- **[JSON Serialization](/documentation/ack/essentials/json-serialization)**: Exporting schemas
