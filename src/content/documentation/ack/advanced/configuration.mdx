...
Annotate a top-level schema with `@AckType()` to generate a typed wrapper — see [TypeSafe Schemas](/documentation/ack/advanced/typesafe-schemas) for setup and supported shapes.
