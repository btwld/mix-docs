...
description: Install the Ack validation library and its optional code generator
---
...
See [TypeSafe Schemas](/documentation/ack/advanced/typesafe-schemas) for more `@AckType` examples and supported schema shapes.
