---
title: Schemas
description: Tour Ack's schema types, from strings and objects to unions and recursive schemas
---
...
> format and keeps the value a `String`. [`Ack.date()`](/documentation/ack/advanced/codecs) (a codec)
...
Every `safeParse()` returns a `SchemaResult` holding the validated value or a `SchemaError`. See [Error Handling](/documentation/ack/essentials/error-handling) for reading values and errors.

## Next steps

- **[Validation rules](/documentation/ack/essentials/validation)**: All built-in constraints and strict parsing
- **[Error handling](/documentation/ack/essentials/error-handling)**: Handle validation errors effectively
- **[Custom validation](/documentation/ack/how-to-guides/custom-validation)**: Create custom constraints and refinements
- **[JSON serialization](/documentation/ack/essentials/json-serialization)**: Validate and transform JSON data
- **[Common recipes](/documentation/ack/how-to-guides/common-recipes)**: Practical schema patterns
