...
description: Validate, encode, and parse JSON data with Ack schemas and typed wrappers
---
...
Once a schema is annotated with `@AckType()` (see [TypeSafe Schemas](/documentation/ack/advanced/typesafe-schemas) for setup), parse JSON straight into typed getters — no manual casting:
