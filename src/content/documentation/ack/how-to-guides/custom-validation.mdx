...
description: Create custom value constraints and cross-field refinements for Ack schemas
---

# Custom Validation Rules

While Ack provides many [built-in validation rules](/documentation/ack/essentials/validation), you can extend them with your own value-level constraints or object-level refinement logic.

## Prerequisites

- **[Validation Rules](/documentation/ack/essentials/validation)**: Built-in constraints and how they work
- **[Schema Types](/documentation/ack/essentials/schemas)**: Different schema types and their behavior
- **[Error Handling](/documentation/ack/essentials/error-handling)**: How validation errors are structured
...
- [Common Recipes](/documentation/ack/how-to-guides/common-recipes) — custom constraints in real-world schemas
- [Flutter Form Validation](/documentation/ack/how-to-guides/flutter-form-validation) — surface custom messages in forms
- [Error Handling](/documentation/ack/essentials/error-handling) — read `SchemaConstraintsError`
