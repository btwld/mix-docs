...
description: Copy ready-made Ack recipes for emails, nested objects, lists, and enums
---
...
- [Custom validation guide](/documentation/ack/how-to-guides/custom-validation) — deep dive into custom validators
- [Flutter form validation](/documentation/ack/how-to-guides/flutter-form-validation) — integrate with Flutter forms
- [Codecs](/documentation/ack/advanced/codecs) — date, URI, and custom value conversions
- [JSON Schema integration](/documentation/ack/advanced/json-schema-integration) — export schemas for API docs and tools
- [Schema types](/documentation/ack/essentials/schemas) — all available schema types
- [Validation rules](/documentation/ack/essentials/validation) — complete constraint reference
