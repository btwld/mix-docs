...
function SeverityMock() {
  const rows = [
    { name: "Critical", count: 1, color: BAND_COLORS.F },
    { name: "High", count: 6, color: BAND_COLORS.D },
  ];
  return (
    <div className="lp-tile-body">
  ...
  return (
    <section className="lp-shell lp-gap" id="impact">
      <SectionHead
        ...
        title="Numbers your board can read."
        lead="Engineers get file:line evidence. You get the same findings as exposure, liability, and effort — every figure sourced in the report. Sample data from a real, anonymized assessment."
      />
